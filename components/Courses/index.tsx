...
//         </div>
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
//           <div className="bg-[var(--light-gray)] rounded-[10px] overflow-hidden shadow-[0_5px_15px_rgba(0,0,0,0.05)] transition-transform duration-300 hover:-translate-y-[5px]">
//             <div className="w-full h-[180px] bg-[var(--mid-gray)] flex items-center justify-center">
//               <svg 
//                 xmlns="http://www.w3.org/2000/svg" 
//                 width="64" 
...
//             </div>
//             <div className="p-6">
//               <h3 className="text-[1.2rem] mb-2">AI Alignment Fast-Track</h3>
//               <p className="text-[0.9rem] text-[#666] mb-6">
//                 A comprehensive introduction to the technical aspects of aligning advanced AI systems with human values and intentions.
//               </p>
//               <a href="https://aisafetyfundamentals.com/alignment-fast-track/" className="btn btn-secondary">Learn More</a>
//             </div>
//           </div>
...
//             </div>
//             <div className="p-6">
//               <h3 className="text-[1.2rem] mb-2">Governance Fast-Track</h3>
//               <p className="text-[0.9rem] text-[#666] mb-6">
//                 Explore approaches to AI governance, policy development, and institutional design for managing AI risks.
//               </p>
//               <a href="https://aisafetyfundamentals.com/governance-fast-track/" className="btn btn-secondary">Learn More</a>
//             </div>
//           </div>
...
//             </div>
//             <div className="p-6">
//               <h3 className="text-[1.2rem] mb-2">Intro to Transformative AI</h3>
//               <p className="text-[0.9rem] text-[#666] mb-6">
//                 A foundational course on the potential of advanced AI systems to transform society and the associated risks and opportunities.
//               </p>
//               <a href="https://aisafetyfundamentals.com/intro-to-tai/" className="btn btn-secondary">Learn More</a>
//             </div>
//           </div>
...
//             </div>
//             <div className="p-6">
//               <h3 className="text-[1.2rem] mb-2">Economics of Transformative AI</h3>
//               <p className="text-[0.9rem] text-[#666] mb-6">
//                 Understand the economic implications of advanced AI, including labor markets, inequality, and growth dynamics.
//               </p>
//               <a href="https://aisafetyfundamentals.com/economics-of-tai/" className="btn btn-secondary">Learn More</a>
//             </div>
//           </div>
//         </div>
//       </div>
